...
import Users from '../api/dao/dbManager/UsersManagerDB';
...
const cookieExtractor = (req) => {
    if (req && req.cookies) { return req.cookies[COOKIE] }
    return null;
}
...
const initializePassport = async() => {
    ...
    passport.use('current', new JwtStrategy({ jwtFromRequest: JWTExtractor.fromExtractors([cookieExtractor]), secretOrKey: SECRET_TOKEN}, async(jwt_payload, done) => {
        try {
